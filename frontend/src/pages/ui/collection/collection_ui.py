...
"}")
        ...
        sizePolicy2.setHeightForWidth(self.wishlist_button_2.sizePolicy().hasHeightForWidth())
        self.wishlist_button_2.setSizePolicy(sizePolicy2)
        ...
        sizePolicy2.setHeightForWidth(self.products_button.sizePolicy().hasHeightForWidth())
        self.products_button.setSizePolicy(sizePolicy2)
