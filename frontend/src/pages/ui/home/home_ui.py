...
"}")
        ...
        pixmap = QPixmap(u":/post_images/IMG_7109.jpg")
        scaled_pixmap = pixmap.scaled(230, 230, Qt.KeepAspectRatio)
        self.post_image_16.setPixmap(scaled_pixmap)
        self.post_image_16.setScaledContents(False)
...
"color:rgb(206, 141, 80);")
        ...
        pixmap = QPixmap(u":/post_images/IMG_7107.jpg")
        scaled_pixmap = pixmap.scaled(230, 230, Qt.KeepAspectRatio)
        self.post_image_14.setPixmap(scaled_pixmap)
        self.post_image_14.setScaledContents(False)
...
"}")
        ...
        pixmap = QPixmap(u":/post_images/IMG_7106.jpg")
        scaled_pixmap = pixmap.scaled(230, 230, Qt.KeepAspectRatio)
        self.post_image_17.setPixmap(scaled_pixmap)
        self.post_image_17.setScaledContents(False)
...
"}")
        ...
        pixmap = QPixmap(u":/post_images/IMG_7102.jpg")
        scaled_pixmap = pixmap.scaled(230, 230, Qt.KeepAspectRatio)
        self.post_image_15.setPixmap(scaled_pixmap)
        self.post_image_15.setScaledContents(False)
...
"}")
        ...
        pixmap = QPixmap(u":/post_images/IMG_7108.jpg")
        scaled_pixmap = pixmap.scaled(230, 230, Qt.KeepAspectRatio)
        self.post_image_18.setPixmap(scaled_pixmap)
        self.post_image_18.setScaledContents(False)
...
"}")
        ...
        pixmap = QPixmap(u":/post_images/IMG_7105.jpg")
        scaled_pixmap = pixmap.scaled(230, 230, Qt.KeepAspectRatio)
        self.post_image_19.setPixmap(scaled_pixmap)
        self.post_image_19.setScaledContents(False)
...
"color:rgb(206, 141, 80);")
        ...
        self.name_label.setStyleSheet("color: black; font:700 11pt Manrope;")
        font5 = QFont()
