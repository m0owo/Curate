...
"}")
        ...
        self.products_button_2 = QPushButton(self.frame_5)
        self.products_button_2.setObjectName(u"products_button_2")
        sizePolicy1.setHeightForWidth(self.products_button_2.sizePolicy().hasHeightForWidth())
        self.products_button_2.setSizePolicy(sizePolicy1)
        self.products_button_2.setMinimumSize(QSize(0, 0))
        self.products_button_2.setFont(font8)

        self.horizontalLayout_3.addWidget(self.products_button_2)
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.path_label.setText(QCoreApplication.translate("MainWindow", u"<html><head/><body><p><span style=\" color:#000000;\">Home &gt; Collection_name &gt; Product_name</span></p></body></html>", None))
        self.image_label.setText("")
        self.image_label_2.setText("")
        self.label_2.setText(QCoreApplication.translate("MainWindow", u"Product", None))
        self.name_label.setText(QCoreApplication.translate("MainWindow", u"Product_name", None))
        ...
        self.products_button_2.setText(QCoreApplication.translate("MainWindow", u"Enqueue", None))
